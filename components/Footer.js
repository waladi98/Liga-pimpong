...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-l from-gray-700 via-gray-900 to-black h-screen">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div>
              <p className="font-medium text-white">Kontak Kami</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75" href="#">
                  {" "}
                  lpjkn@gmail.com{" "}
            ...
            <div>
              <p className="font-medium text-white">Kebijakan</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75" href="#">
                  {" "}
                  Privacy Policy{" "}
            ...
            <div>
              <p className="font-medium text-white">Didukung Oleh:</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75" href="#">
                  {" "}
                  sponsor 1{" "}
